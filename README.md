...
- `Typescript`, `Vitest`, `Design Patterns`, `SOLID`, `Docker`, `Linux`, `Bash`, `Cron`, `Curl`, `Jira`, `Bitbucket`, 
`AJAX`, `JQuery`, `Bootstrap`, `PHPUnit`, `Pest`, `Guzzle`, `DataTables`, `Swiper.js`, `SweetAlert`
